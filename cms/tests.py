...
class SimpleTest(TestCase):
    def setUp(self):
        self.page1 = Page.objects.create(slug="", name="Home page", type=PAGE_TYPE_STATIC)
    ...
    def test_creation(self):
        self.page1 = Page.objects.get(id=1)
        ...
        self.assertEquals(list(Page.active_objects.all()), [self.page1, self.page2] )
